...
nav: true
nav_order: 1
description: My PhD research spans three technical pillars — real-time imaging, theranostic imaging, and medical AI — tied together by a thread of pre-clinical translation.
---

I build **real-time imaging systems** for **image-guided minimally invasive procedures** — across the four interconnected areas below. Selected publications appear on the [home page](/), and the full list on the [publications page](/publications/).

## Real-Time Imaging & Thermal-Ablation Monitoring
...
## Theranostic Imaging for Drug Delivery
